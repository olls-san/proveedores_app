...
# 👇 Importa solo lo que necesitas, sin pasar por backend/__init__.py
from .models import Supplier

# ==== CONFIG JWT ====
# SUGERENCIA: define SECRET_KEY en variables de entorno en Render
# y léela con os.getenv("SECRET_KEY", "cámbiame").
SECRET_KEY = "change-me-in-env"
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = 60 * 24

# ==== HASHING ====
# bcrypt_sha256 evita el límite de 72 bytes del bcrypt clásico.
